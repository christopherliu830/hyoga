...
pub const BackendFlagsNames = struct {
    pub const none: c_int = 0;
    pub const has_gamepad: c_int = 1;
    pub const has_mouse_cursors: c_int = 2;
    pub const has_set_mouse_pos: c_int = 4;
    pub const renderer_has_vtx_offset: c_int = 8;
    pub const platform_has_viewports: c_int = 1024;
    pub const has_mouse_hovered_viewport: c_int = 2048;
    pub const renderer_has_viewports: c_int = 4096;
};
...
pub const MouseCursorNames = struct {
    pub const none: c_int = -1;
    pub const arrow: c_int = 0;
    pub const text_input: c_int = 1;
    pub const resize_all: c_int = 2;
    pub const resize_ns: c_int = 3;
    pub const resize_ew: c_int = 4;
    pub const resize_nesw: c_int = 5;
    pub const resize_nwse: c_int = 6;
    pub const hand: c_int = 7;
    pub const not_allowed: c_int = 8;
    pub const count: c_int = 9;
};
...
pub const getColorU = igGetColorU;
...
pub const getStyleColorVec = igGetStyleColorVec;
...
pub const checkboxFlags = igCheckboxFlags;
...
pub const dragFloatRange = igDragFloatRange;
...
pub const dragIntRange = igDragIntRange;
...
pub const colorEdit = igColorEdit;
...
pub const colorPicker = igColorPicker;
...
pub const colorConvertU = igColorConvertU;
pub extern fn igColorConvertFloat4ToU32(in: Vec4) u32;
pub const colorConvertFloat = igColorConvertFloat;
...
pub const imIsPowerOfTwo = igImIsPowerOfTwo;
...
pub const imTextCharToUtf = igImTextCharToUtf;
...
pub const imTextFindPreviousUtf = igImTextFindPreviousUtf;
...
pub const imLengthSqr = igImLengthSqr;
...
pub const markIniSettingsDirty = igMarkIniSettingsDirty;
...
pub const getKeyData = igGetKeyData;
...
pub const getKeyMagnitude = igGetKeyMagnitude;
...
pub const dockNodeWindowMenuHandler = igDockNodeWindowMenuHandler;
...
pub const tableGcCompactTransientBuffers = igTableGcCompactTransientBuffers;
...
pub const imFontAtlasBuildRender = igImFontAtlasBuildRender;
...
pub const imFontAtlasBuildMultiplyRectAlpha = igImFontAtlasBuildMultiplyRectAlpha;
