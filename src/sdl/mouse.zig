...
//    size: ?*const fn (?*anyopaque) callconv(.C) Sint64 = @import("std").mem.zeroes(?*const fn (?*anyopaque) callconv(.C) Sint64),
	size: ?*const fn (?*anyopaque) callconv(.C) i64 = @import("std").mem.zeroes(?*const fn (?*anyopaque) callconv(.C) i64),
//    seek: ?*const fn (?*anyopaque, Sint64, SDL_IOWhence) callconv(.C) Sint64 = @import("std").mem.zeroes(?*const fn (?*anyopaque, Sint64, SDL_IOWhence) callconv(.C) Sint64),
	seek: ?*const fn (?*anyopaque, i64, IOWhence) callconv(.C) i64 = @import("std").mem.zeroes(?*const fn (?*anyopaque, i64, IOWhence) callconv(.C) i64),
//    read: ?*const fn (?*anyopaque, ?*anyopaque, usize, [*c]SDL_IOStatus) callconv(.C) usize = @import("std").mem.zeroes(?*const fn (?*anyopaque, ?*anyopaque, usize, [*c]SDL_IOStatus) callconv(.C) usize),
	read: ?*const fn (?*anyopaque, ?*anyopaque, usize, [*c]IOStatus) callconv(.C) usize = @import("std").mem.zeroes(?*const fn (?*anyopaque, ?*anyopaque, usize, [*c]IOStatus) callconv(.C) usize),
//    write: ?*const fn (?*anyopaque, ?*const anyopaque, usize, [*c]SDL_IOStatus) callconv(.C) usize = @import("std").mem.zeroes(?*const fn (?*anyopaque, ?*const anyopaque, usize, [*c]SDL_IOStatus) callconv(.C) usize),
	write: ?*const fn (?*anyopaque, ?*const anyopaque, usize, [*c]IOStatus) callconv(.C) usize = @import("std").mem.zeroes(?*const fn (?*anyopaque, ?*const anyopaque, usize, [*c]IOStatus) callconv(.C) usize),
//    flush: ?*const fn (?*anyopaque, [*c]SDL_IOStatus) callconv(.C) SDL_bool = @import("std").mem.zeroes(?*const fn (?*anyopaque, [*c]SDL_IOStatus) callconv(.C) SDL_bool),
	flush: ?*const fn (?*anyopaque, [*c]IOStatus) callconv(.C) bool = @import("std").mem.zeroes(?*const fn (?*anyopaque, [*c]IOStatus) callconv(.C) bool),
...
pub extern fn SDL_IOvprintf(context: ?*IOStream, fmt: [*c]const u8, ap: va_list) usize;
...
pub extern fn SDL_SetSurfaceColorKey(surface: [*c]Surface, enabled: bool, key: u32) bool;
...
pub extern fn SDL_GetSurfaceColorKey(surface: [*c]Surface, key: [*c]u32) bool;
...
pub extern fn SDL_SetSurfaceColorMod(surface: [*c]Surface, r: u8, g: u8, b: u8) bool;
...
pub extern fn SDL_GetSurfaceColorMod(surface: [*c]Surface, r: [*c]u8, g: [*c]u8, b: [*c]u8) bool;
...
pub extern fn SDL_SetSurfaceAlphaMod(surface: [*c]Surface, alpha: u8) bool;
...
pub extern fn SDL_GetSurfaceAlphaMod(surface: [*c]Surface, alpha: [*c]u8) bool;
...
pub extern fn SDL_FillSurfaceRect(dst: [*c]Surface, rect: [*c]const Rect, color: u32) bool;
...
pub extern fn SDL_FillSurfaceRects(dst: [*c]Surface, rects: [*c]const Rect, count: c_int, color: u32) bool;
...
pub extern fn SDL_MapSurfaceRGB(surface: [*c]Surface, r: u8, g: u8, b: u8) u32;
...
pub extern fn SDL_MapSurfaceRGBA(surface: [*c]Surface, r: u8, g: u8, b: u8, a: u8) u32;
...
pub extern fn SDL_ReadSurfacePixel(surface: [*c]Surface, x: c_int, y: c_int, r: [*c]u8, g: [*c]u8, b: [*c]u8, a: [*c]u8) bool;
...
pub extern fn SDL_WriteSurfacePixel(surface: [*c]Surface, x: c_int, y: c_int, r: u8, g: u8, b: u8, a: u8) bool;
...
pub const WindowFlags = packed struct (u64) {
	...
	pos_undefined_mask: bool = false,
	pos_undefined: bool = false,
	pos_centered_mask: bool = false,
	pos_centered: bool = false,
	surface_vsync_disabled: bool = false,
	surface_vsync_adaptive: bool = false,
	_padding: u0 = 0,
};
