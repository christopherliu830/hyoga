...
pub const ProcTable = extern struct {
    ...
    hy_engine_phys2: *const fn (*Engine) callconv(.c) *p2.Context,
    ...
    hy_p2_reset: *const fn (world: *p2.Context) callconv(.c) void,
    hy_p2_bodyAdd: *const fn (world: *p2.Context, opts: *const p2.BodyAddOptions) callconv(.c) p2.Body,
    hy_p2_bodyShapeAdd: *const fn (body: p2.Body, shape: *const p2.BodyAddOptions) callconv(.c) void,
    hy_p2_bodyDestroy: *const fn (body: p2.Body) callconv(.c) void,
    hy_p2_bodyUserData: *const fn (body: p2.Body) callconv(.c) ?*anyopaque,
    hy_p2_bodyUserDataSet: *const fn (body: p2.Body, user_data: ?*anyopaque) callconv(.c) void,
    hy_p2_bodyPosition: *const fn (world: *p2.Context, body: p2.Body) callconv(.c) hym.Vec2,
    ...
    hy_p2_eventPump: *const fn (world: *p2.Context, buffer: hy.ExternSlice(u8)) callconv(.c) u32,
    hy_p2_overlapLeaky: *const fn (world: *p2.Context, arena: hy.ExternAllocator, shape: *const p2.ShapeConfig, origin: hym.Vec2) callconv(.c) hy.ExternSlice(p2.Shape),
    hy_p2_castRayLeaky: *const fn (world: *p2.Context, arena: hy.ExternAllocator, opts: p2.RaycastOptions) callconv(.c) hy.ExternSlice(p2.RaycastHit),
    hy_p2_castCircleLeaky: *const fn (world: *p2.Context, arena: hy.ExternAllocator, opts: p2.CastCircleOptions) callconv(.c) hy.ExternSlice(p2.RaycastHit),
