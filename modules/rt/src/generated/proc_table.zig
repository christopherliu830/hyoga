...
pub const ProcTable = extern struct {
    ...
    hy_gfx_materialCreate: *const fn (gpu: *hy.gfx.Gpu, mt_type: hy.gfx.MaterialType, tx_set: *const hy.gfx.TextureArray) callconv(.c) hy.gfx.MaterialHandle,
    ...
    hy_gfx_spriteMakeRenderable: *const fn (gpu: *hy.gfx.Gpu, hdl: hy.gfx.Sprite.Handle) callconv(.c) hy.gfx.Renderable,
    hy_gfx_spriteCreate: *const fn (gpu: *hy.gfx.Gpu, opts: hy.gfx.SpriteCreateOptions) callconv(.c) hy.gfx.Sprite.Handle,
    hy_gfx_spriteDestroy: *const fn (gpu: *hy.gfx.Gpu, hdl: hy.gfx.Sprite.Handle) callconv(.c) void,
    ...
    hy_gfx_spriteDupe: *const fn (gpu: *hy.gfx.Gpu, hdl: hy.gfx.Sprite.Handle) callconv(.c) hy.gfx.Sprite.Handle,
...
pub const table: ProcTable = .{
    ...
    .hy_gfx_spriteMakeRenderable = root.hy_gfx_spriteMakeRenderable,
